...
class MODEL():
    ...
    def init_fosys(self):
        ...
        self.fosys.add_optic(self.planes['ADC-pp'], distance=self.distances['fm5_ADC-pp'] + self.ADCpupil_correction)
        self.fosys.add_optic(self.planes['fm6'], distance=self.distances['ADC-pp_fm6'] - self.ADCpupil_correction)
