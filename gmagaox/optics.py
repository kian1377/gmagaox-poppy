...
distances = {
    ...
    'fm1_fsm-pp':8.064222541315394E+001 * u.mm, 
    ...
    'fm5_ADCpupil': 2.144927190484304E+002 * u.mm, 
    'ADCpupil_fm6': 1.082692247451923E+002 * u.mm,
    ...
    'AOoap3_woofer': 6.346731311959666E+002 * u.mm, 
    'woofer_AOoap4': 1.264141420946085E+003 * u.mm, 
    ...
    'AOoap5_tweeter': 1.119728932177350E+003 * u.mm, 
    # 'tweeter_AOoap5':  * u.mm, 
    # 'AOoap5_fm10':  * u.mm, 
    # 'fm10_ifp15':  * u.mm, 
...
planes = {
    ...
    'ADCpupil':poppy.ScalarTransmission(name='ADC pupil'),
