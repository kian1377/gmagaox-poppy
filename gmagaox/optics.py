...
distances = {
    ...
    'knifeedge_AOoap6': 1.785101845577738E+002 * u.mm + 7.999999999697138e-05*u.mm, 
    'AOoap6_fpsm-pp': 1.792881819770701E+002 * u.mm + 0.6606599999999787*u.mm, 
    'fpsm-pp_pfm1': 3.004115486611408E+001 * u.mm, 
    ...
    'fm14_ncpDM': 8.800000000000000E+002 * u.mm,
    'ncpDM_apodizer': 8.500000001020817E+001 * u.mm, 
...
focal_lengths = {
    ...
    'AOoap7':827.95535*u.mm, 
    # 'AOoap8':1418.956363*u.mm,
    'AOoap8':1655.8481*u.mm,  
    'AOoap8':1655.825*u.mm,
    # 'AOoap8': 1689.936177*u.mm, 
    'AOoap9-1':820.6511062*u.mm, 
    # 'AOoap9-2':832.9611995*u.mm, 
    # 'AOoap9-2':849.83499*u.mm, 
    'AOoap9-2':863.5968*u.mm,
    'AOoap9-3':805.9096915*u.mm, 
    'AOoap9-3':863.60372*u.mm, 
}
...
planes = {
    ...
    'fpsm-pp':poppy.ScalarTransmission(name='focal plane SM - pp'), 
    ...
    'ncpDM':poppy.ScalarTransmission(name='ncpDM-pp'), 
    'apodizer':poppy.ScalarTransmission(name='Apodizer-pp'),
    ...
    'lyot-pp':poppy.ScalarTransmission(name='Lyot-pp'), 
