...
distances = {
    ...
    'tweeter-pp_AOoap5': 1.119728923126684E+003 * u.mm, 
    'AOoap5_fm10': 9.451950001214136E+002 * u.mm, 
    'fm10_ifp15': 1.500000002282177E+002 * u.mm, 
    'ifp15_knifeedge': 1.438574521038390E+000 * u.mm, 
    'knifeedge_AOoap6': 1.785101845577738E+002 * u.mm, 
    'AOoap6_fpsm': 1.792881819770701E+002 * u.mm, 
    'fpsm_pfm1': 3.004115486611408E+001 * u.mm, 
    'pfm1_pfm2': 4.053605987269912E+002 * u.mm, 
    'pfm2_AOoap7': 2.210467694796171E+002 * u.mm, 
    'AOoap7_fm11': 1.117261740307658E+002 * u.mm, 
    'fm11_ifp69': 7.162291720413195E+002 * u.mm, 
    'ifp69_pupilSM': 3.000004582347174E+000 * u.mm, 
    'pupilSM_fm12': 1.039038602138491E+003 * u.mm, 
    'fm12_AOoap8': 6.138094877163458E+002 * u.mm,
    'AOoap8_fm13': 1.116771787932783E+003 * u.mm,  
    'fm13_fm14': 2.800000000000000E+002 * u.mm, 
    'fm14_ncpDM': 9.650000000102082E+002 * u.mm,
    'ncpDM_AOoap9-1': 8.206110132276008E+002 * u.mm, # should be a 24mm pupil plane
    'AOoap91_fm15': 2.279598983720862E+002 * u.mm, 
    'fm15_ifp34.5': 6.000000000000000E+002 * u.mm, 
    'ifp34p5_AOoap9-2': 8.635967976970424E+002 * u.mm, 
    'AOoap92_lyot-pp': 8.498349949126568E+002 * u.mm, 
    'lyot-pp_fm16': 7.499983552419872E+001 * u.mm, # should be about a 25.2mm pupil 
    'fm16_AOoap9-3': 7.168855598646333E+002 * u.mm, 
    'AOoap93_fm17': 1.477444651680999E+002 *u.mm, 
    'fm17_scicamfp34.5': 7.158592516354256E+002 * u.mm, 
    # '': * u.mm, 
    # '': * u.mm, 
}
...
focal_lengths = {
    ...
    'AOoap6':179.9488382*u.mm, 
    'AOoap7':682.4406862*u.mm, 
    'AOoap8':1418.956363*u.mm, 
    'AOoap9-1':820.6511062*u.mm, 
    'AOoap9-2':832.9611995*u.mm, 
    'AOoap9-3':805.9096915*u.mm, 
}
